...
def train(config):
    ...
    for _ in range(num_steps):
        ...
        print(X_train.shape)
        print(y_train.shape)
        print(X_train[index_start:index_end,].shape)
        print(y_train[index_start:index_end,].shape)
        print(type(X_train))
        print(type(y_train))
        print(type(X_train[index_start:index_end,]))
        print(type(y_train[index_start:index_end,]))
        exit()
